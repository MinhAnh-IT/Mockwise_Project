...
/**
 * Authenticates service-to-service calls hitting {@code /internal/**} by
 * checking the {@code X-Internal-Auth} header against the shared API key.
 * On success, seeds ROLE_INTERNAL so downstream authorization can permit it.
 */
@Slf4j
